...
export const windowPanelCommands: Commande[] = [
  ...
  },
  {
    id: "panneau:whales",
    mnemonique: "WHALES",
    libelle: "Mouvements de baleines",
    categorie: "panneau",
    motsCles: [
      "baleines",
      "whales",
    ...
    apercu: "Ouvre / ferme les gros transferts on-chain et les positions des top comptes Hyperliquid",
    action: basculer("whales"),
  },
  {
    id: "panneau:cycle",
    mnemonique: "CYCLE",
  ...
  {
    id: "panneau:btc-power-law",
    mnemonique: "BPL",
    libelle: "Bitcoin Power Law",
    categorie: "panneau",
    motsCles: [
      "bitcoin",
      "btc",
    ...
    apercu: "Ouvre / ferme le modèle de puissance BTC et ses bandes de présence historiques",
    action: basculer("btcPowerLaw"),
  },
  {
    id: "panneau:evts",
    mnemonique: "EVTS",
  ...
  },
  {
    ...
    apercu: "Ouvre / ferme la performance par secteur crypto (mapping curé, perf pondérée par cap)",
    action: basculer("sect"),
  },
  {
