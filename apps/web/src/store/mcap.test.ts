...
function tuile(id: string, symbol: string, mcapUsd: number): CoinTile {
  return { id, symbol, name: symbol, mcapUsd, price: 1, volume24hUsd: null, observeLe: null, changePct24h: 0, changePct7j: 0, changePct30j: 0, changePct1h: null, changePct24hConnu: 0 };
}
