...
|---|---|---|
| 1–4 : ETF, référentiels, CHAIN, qualité | 1 | Corrections de revue sur les métadonnées des caches en cours |
| 5–7 : macro, ALFRED, TGA/NETLIQ | 2 | Approuvé après corrections, tête `fa24839` |
| 8–9 : flux communs et économie des chaînes | 4 | Dépend des interfaces de qualité du lot1 |
| 10 : ECO/EVTS, publications et réactions | 5 | Implémentation en cours sur les API ALFRED approuvées |
| 11–12 : DOM/EQS, gamma et régime | 6 | Préparation des sources et conventions effectuée |
| 13–14 : WHALES, unlocks et bridges | 7 | Sources et contrat Pro préparés ; accès personnel absent |
| 15 : backtest, causalité, funding et OOS | 3 | Implémentation en cours ; protocole figé avant acquisition |
