...
Généré par `scripts/valider-strategies.ts` le 2026-07-28. **Toutes les valeurs ci-dessous sont des mesures PASSÉES, in-sample pour la sélection du champion — jamais une promesse de performance.**

## Méthodologie

- **Données** : klines Binance spot (`/api/v3/klines`), bougie en cours exclue, depuis le 2024-07-01.
...
| ETHUSDT 1h | 18181 | 2024-07-01 | 2026-07-28 |
...
| Stratégie | Trades | Win % | PnL total % | DD max % | Profit factor | Expectancy BT % | Expectancy rejeu % | Écart |
|---|---|---|---|---|---|---|---|---|
| stratCroisementMM | 780 | 27.18 | -2.39 | 9.14 | 0.97 | -0.031 | 0.053 | -0.083 |
| stratRsiReversion | 71 | 57.75 | -8.55 | 10.40 | 0.64 | -1.204 | -1.088 | -0.115 |
| stratMacdCross | 1270 | 33.15 | -16.53 | 17.75 | 0.86 | -0.130 | 0.031 | -0.161 |
| stratSupertrend | 446 | 31.17 | -10.51 | 14.10 | 0.86 | -0.236 | -0.098 | -0.137 |
| stratBollingerReversion | 347 | 66.57 | -5.37 | 6.40 | 0.82 | -0.155 | 0.023 | -0.178 |
| stratMmAdx | 329 | 34.04 | -3.19 | 13.57 | 0.95 | -0.097 | 0.152 | -0.248 |
...
- `stratSupertrend` — fidèle : déjà en NIVEAU (direction du Supertrend 10 ×3) — 217 longs / 218 shorts sur BTCUSDT 1h, la parité attendue d'un système à retournement
