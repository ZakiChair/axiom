...
describe("rv — Realized Volatility (annualisée)", () => {
  ...
  it("calcule RV avec length=3, periodesParAn=365 sur une série connue", () => {
    ...
    //            = [undefined, 0.0953101798..., -0.0512932944..., 0.0957450570...]
    // À i=3 (index 3) : window = [0.0953101798, -0.0512932944, 0.0957450570]
    // sum = 0.1397619423...
    // sumSq = 0.0090840304... + 0.0026307966... + 0.0091301536... = 0.0208549806...
    // variance_pop = (0.0208549806 - (0.1397619423)^2 / 3) / 3
    //              = (0.0208549806 - 0.0065052618) / 3
    //              = 0.0143497188 / 3
    //              = 0.0047832396
    // stdev = sqrt(0.0047832396) = 0.0692122697
    // rv = 0.0692122697 * sqrt(365) * 100
    //    = 0.0692122697 * 19.10497 * 100
    //    = 132.22985565...%
    //
